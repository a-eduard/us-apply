      ...
      <form onSubmit={handleProfileSubmit(onProfileSubmit, onError)} className="space-y-5 sm:space-y-6 bg-white p-5 sm:p-8 rounded-2xl border border-slate-200 shadow-sm">
        ...
        <div className="space-y-1.5">
          ...
          <input 
            ...
            className={cn("w-full px-4 py-3 sm:py-2.5 rounded-xl border outline-none bg-slate-50 transition-colors text-base sm:text-sm", profileErrors.email ? "border-red-500 focus:ring-2 focus:ring-red-500" : "border-slate-300 focus:ring-2 focus:ring-blue-600/20 focus:border-blue-600")}
          />
