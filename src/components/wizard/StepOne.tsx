...
const StepOne = forwardRef(function StepOne({ 
  ...
  return (
    <div className="space-y-6 max-w-lg mx-auto w-full">
      ...
      {isGuest && (
        <div className="mb-8">
          ...
          <div className="mt-6 flex items-center gap-4">
            ...
            <span className="text-[10px] text-slate-400 font-extrabold uppercase tracking-widest">Or register with email</span>
            <div className="h-px bg-slate-200 flex-1"></div>
          </div>
        </div>
      )}
      ...
      {authError && (
        <div className="p-3 bg-red-50 text-red-600 text-sm font-bold rounded-lg border border-red-100 text-center mb-6 animate-in fade-in">
          {authError}
        </div>
      )}
      ...
      <form onSubmit={handleProfileSubmit(onProfileSubmit, onError)} className="space-y-6 bg-white p-6 sm:p-8 rounded-2xl border border-slate-200 shadow-sm">
        ...
        <div className="space-y-1.5">
          ...
          <input 
            ...
            className={cn("w-full px-4 py-2.5 rounded-xl border outline-none bg-slate-50 transition-colors text-sm disabled:opacity-60 disabled:cursor-not-allowed", profileErrors.email ? "border-red-500 focus:ring-2 focus:ring-red-500" : "border-slate-300 focus:ring-2 focus:ring-blue-600/20 focus:border-blue-600")}
          />
        ...
        {isGuest && (
          <div className="space-y-1.5">
            ...
            <input 
              ...
              className={cn("w-full px-4 py-2.5 rounded-xl border outline-none bg-slate-50 transition-colors text-sm", profileErrors.password ? "border-red-500 focus:ring-2 focus:ring-red-500" : "border-slate-300 focus:ring-2 focus:ring-blue-600/20 focus:border-blue-600")}
            />
        ...
        <div className="pt-6">
          <button type="submit" disabled={loading} className="w-full bg-blue-600 text-white font-bold py-3.5 rounded-xl hover:bg-blue-700 transition-all shadow-lg shadow-blue-600/20 active:scale-[0.98] disabled:opacity-50 flex items-center justify-center gap-2">
