    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col font-sans text-slate-900 dark:text-slate-100 relative transition-colors duration-300 pb-12">
      ...
      <main className="flex-1 w-full max-w-3xl mx-auto p-4 sm:p-8 mt-4 sm:mt-6">
        <div className="mb-6 sm:mb-8 text-center sm:text-left">
          <h1 className="text-2xl sm:text-3xl font-extrabold text-slate-900 dark:text-white mb-2 transition-colors">Edit Campaign</h1>
          <p className="text-sm sm:text-base text-slate-500 dark:text-slate-400 font-medium transition-colors">Update the details of your job posting.</p>
        </div>
