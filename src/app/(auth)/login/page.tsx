      ...
      <div className="w-full max-w-md p-8 bg-white rounded-2xl shadow-sm border border-slate-200">
        ...
        <div className="mt-6 grid grid-cols-2 gap-4">
          <button
            ...
            disabled
            title="Coming soon"
            className="flex items-center justify-center gap-2 px-4 py-2.5 border border-slate-300 rounded-xl bg-slate-50 text-sm font-bold text-slate-400 opacity-60 cursor-not-allowed shadow-sm"
          >
            <svg className="w-5 h-5 shrink-0 opacity-70" viewBox="0 0 24 24">
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 px-4 py-2.5 border border-slate-300 rounded-xl bg-slate-50 text-sm font-bold text-slate-400 opacity-60 cursor-not-allowed shadow-sm"
          >
            <svg className="w-5 h-5 shrink-0 opacity-70" fill="#0077B5" viewBox="0 0 24 24">
